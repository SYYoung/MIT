...
def epsilon_greedy(state_1, state_2, q_func, epsilon):
    ...
    # get max
    max_cur_index_1D = np.argmax(q_func[state_1, state_2])
    max_cur_index = (int(max_cur_index_1D / NUM_OBJECTS ), max_cur_index_1D % NUM_OBJECTS)
    ...
    while not terminal:
        ...
        if for_training:
            ...
            tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
                               object_index, reward, dict_room_desc[next_room_desc],
                               dict_quest_desc[next_quest_desc], terminal)
