...
return null},Df=!1;if(I.querySelectorAll)try{var Ef=I.querySelectorAll(":root");Ef&&1==Ef.length&&Ef[0]==I.documentElement&&(Df=!0)}catch(a){}var Af=Df;var Hd={},Sf=null,Tf=Math.random();Hd.w="GTM-PLVRLF";Hd.Rb="5e1";Hd.Td="";var Uf={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Vf="www.googletagmanager.com/gtm.js";
var Wf=Vf,Xf=null,Yf=null,Zf=null,$f="//www.googletagmanager.com/a?id="+Hd.w+"&cv=102",ag={},bg={},cg=function(){var a=Sf.sequence||0;Sf.sequence=a+1;return a};
...
Z.b.r=["google"],function(){(function(a){Z.__r=a;Z.__r.g="r";Z.__r.h=!0;Z.__r.priorityOverride=0})(function(a){return Ia(a.vtp_min,a.vtp_max)})}();
...
Z.b.awc=["nonGoogleScripts"],function(){var a=!1,b=function(c){if(a)c.vtp_gtmOnSuccess();else{var d=c.vtp_channel||"na",e,f,g;if(c.vtp_group&&0<=c.vtp_group.indexOf(":")){e=c.vtp_group;for(var k=c.vtp_group.split("|"),l=[],m=g=0;m<k.length;m++)if(k[m]){var n=k[m].split(":");if(2==n.length&&n[0]&&n[1]){var r=parseFloat(n[1]);isNaN(r)||(l.push(V(n[0])+":"+r),g+=r)}}f=l.join("|")}else g=c.vtp_orderValue||0,e=(c.vtp_group||"DEFAULT")+":"+g,f=V(c.vtp_group||"DEFAULT")+":"+V(g);var t=c.vtp_testMode?"1":
"0";try{var q=["merchant="+V(c.vtp_merchantId),"ref="+V(c.vtp_orderRef),"amount="+V(g),"parts="+f,"ch="+V(d),"testmode="+t];c.vtp_currency&&q.push("cr="+V(c.vtp_currency));c.vtp_discountCode&&q.push("vc="+V(c.vtp_discountCode));To("https://www.awin1.com/sread.img?tt=ns&tv=2&"+q.join("&"))}catch(v){}try{var u={};u.orderRef=c.vtp_orderRef;u.amount=g;c.vtp_currency&&(u.currency=c.vtp_currency);u.parts=e;c.vtp_discountCode&&(u.voucher=c.vtp_discountCode);u.channel=d;u.test=t;C.AWIN={Tracking:{Sale:u}};
R("https://www.dwin1.com/"+c.vtp_merchantId+".js",c.vtp_gtmOnSuccess,c.vtp_gtmOnFailure);a=!0}catch(v){K(c.vtp_gtmOnFailure)}}};Z.__awc=b;Z.__awc.g="awc";Z.__awc.h=!0;Z.__awc.priorityOverride=0}();
