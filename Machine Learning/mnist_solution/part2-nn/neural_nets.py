...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_error = \
            np.multiply((np.transpose(self.hidden_to_output_weights) * output_layer_error),
                        vec_relu_derivative(hidden_layer_weighted_input))# TODO (3 by 1 matrix)

        bias_gradients = hidden_layer_error # TODO
        hidden_to_output_weight_gradients = \
                    np.transpose(hidden_layer_activation * output_layer_error)# TODO
        input_to_hidden_weight_gradients = \
                    np.transpose(input_values * np.transpose(hidden_layer_error))# TODO
    ...
    def predict(self, x1, x2):
        ...
        hidden_layer_weighted_input = \
            self.input_to_hidden_weights * input_values + self.biases # TODO
        hidden_layer_activation = vec_relu(hidden_layer_weighted_input) # TODO
        output = self.hidden_to_output_weights * hidden_layer_activation # TODO
        activated_output = output_layer_activation(output)# TODO
