...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    # new_train_y, new_test_y = update_y(train_y, test_y)
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    """
    # YOUR CODE HERE
    test_error = run_softmax_on_MNIST(temp_parameter)
    return test_error


# TODO: Run run_softmax_on_MNIST_mod3(), report the error rate
print('run softmax on MNIST mod3 error = ', run_softmax_on_MNIST_mod3())
...
print('PCS 10 with cubic feature, error = ', test_error)