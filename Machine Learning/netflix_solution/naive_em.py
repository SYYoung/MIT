...
def gaussian(x: np.ndarray, mean: np.ndarray, var: float) -> float:
    """ Compute the probability of vector x under a normal distribution

    Args:
        x: (d, ) array olding the vector's coordinates
        mean: (d, ) mean of gaussian
        var: variances of gaussian
