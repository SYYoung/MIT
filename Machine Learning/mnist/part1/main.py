...
lam_factor = 1
print('lambda = ',lam_factor, ' lambLinear Regression test_error =', run_linear_regression_on_MNIST(lam_factor))
...
print('test error on run_PCA = ', test_error)
...
print('test error on run cubic kernel  = ', test_error_cube)