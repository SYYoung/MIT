...
dictionary = p1.bag_of_words_wo_stop_word(train_texts, stop_word_list)
...
sorted_bad_word_features = utils.most_neg_explanatory_word(best_theta, wordlist)
print("Most negative word features")
print(sorted_bad_word_features[:10])